...
public interface UserClient {
    ...
    @WebMethod
    @RequestWrapper(localName = "updateStatusReminderToFalse", targetNamespace = "http://manager.contract.business.library.oc.library.com/", className = "com.library.oc.library.business.contract.manager.UpdateStatusReminderToFalse")
    @ResponseWrapper(localName = "updateStatusReminderToFalseResponse", targetNamespace = "http://manager.contract.business.library.oc.library.com/", className = "com.library.oc.library.business.contract.manager.UpdateStatusReminderToFalseResponse")
    public void updateStatusReminderToFalse(
        @WebParam(name = "idUser", targetNamespace = "")
        java.lang.Integer idUser
    );

    @WebMethod
    @RequestWrapper(localName = "read", targetNamespace = "http://manager.contract.business.library.oc.library.com/", className = "com.library.oc.library.business.contract.manager.Read")
    @ResponseWrapper(localName = "readResponse", targetNamespace = "http://manager.contract.business.library.oc.library.com/", className = "com.library.oc.library.business.contract.manager.ReadResponse")
    @WebResult(name = "return", targetNamespace = "")
    ...
    @WebMethod
    @RequestWrapper(localName = "updateStatusReminderToTrue", targetNamespace = "http://manager.contract.business.library.oc.library.com/", className = "com.library.oc.library.business.contract.manager.UpdateStatusReminderToTrue")
    @ResponseWrapper(localName = "updateStatusReminderToTrueResponse", targetNamespace = "http://manager.contract.business.library.oc.library.com/", className = "com.library.oc.library.business.contract.manager.UpdateStatusReminderToTrueResponse")
    public void updateStatusReminderToTrue(
        @WebParam(name = "idUser", targetNamespace = "")
        java.lang.Integer idUser
    );
